...
\begin{figure}
  ...
  \caption{In step \circled{1}, clients decouple file system subtrees and
interact with their copiese locally for high performance. In step \circled{2},
clients and metadata servers generate subtrees for structured namespaces using
``file types", thus reducing RPC amplification.  \label{fig:intro}}
\end{figure}
%\begin{figure}
%  \centering
