...
interact with their copies locally for high performance. In step \circled{2},
clients and metadata servers generate subtrees using
``namespace schemas", thus reducing RPC load.  \label{fig:intro}}
\end{figure}
