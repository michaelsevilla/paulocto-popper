...
front) into the global namespace. %This workflow is essentially a
...
%The actual implementation is similar to predicate push downs in databases,
%where structure is described to lower storage layers using XML or
